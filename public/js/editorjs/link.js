...
(function (L, T) {
                    ...
                    return new Promise(function (y, r) {
                        ...
                        u.upload.addEventListener("progress", function (m) {
                            ...
                            if (u.readyState === 4) {
                                ...
                                var b = a.parseHeaders(u.getAllResponseHeaders()),
                                    g = {body: m, code: u.status, headers: b};
    ...
    class x {
        ...
        async fetchLinkData(w) {
            ...
            try {
                const {body: d} = await F.get({
                    url: this.config.endpointList,
        ...
        onFetch(w) {
           ...
           console.log("inputs auto complete",w)
            this.autocomplete(this.nodes.input, w);
            // if (!w || !w.success) {
             ...
             inp.parentNode.appendChild(a);
                ...
                for (i = 0; i < arr.length; i++) {
                    ...
                    b.addEventListener("click", function(e) {
                            ...
                            self.fetchProductData(this.getElementsByTagName("input")[0].value)
